...
const helpContents: {[key: string]: string} = {
  ...
  'ecs.serverGroup.clusterName': '<p>The name of the ECS cluster (underlying hosts) onto which your application will be deployed.</p><p>Note that suggestions here are dependent on the selected account and region combination.</p>',
  ...
  'ecs.capacity.reserved.computeUnits': '<p>The assured minimal amount of computing capacity your container will be able to use.  1024 units are equal to 1 Amazon virtual CPU</p> <p>If other containers on your underlying host are not using their reserved compute capacity, this container will be able to use it.</p>',
